...
A high-performance, web-based 2D metaverse ecosystem built with an event-driven Web3 architecture. This project bridges an interactive HTML5 graphic landscape with an on-chain ERC-721 smart contract layer, using low-latency data streams to reflect true asset ownership in real-time.
<hr>
